...
public class CollectionPath extends TableImpl<CollectionPathRecord> {
    ...
    public List<ForeignKey<CollectionPathRecord, ?>> getReferences() {
        return Arrays.asList(Keys.COLLECTION_PATH__FK_COLLECTION_PATH_PK_COLLECTION);
    }
    ...
    public Collection collection() {
        if (_collection == null)
            _collection = new Collection(this, Keys.COLLECTION_PATH__FK_COLLECTION_PATH_PK_COLLECTION);
